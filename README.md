...
- **Backend:** Python (FastAPI), RESTful APIs, Microservices, Event-Driven Architecture.
- **Cloud (AWS):** Lambda, SQS, SNS, API Gateway, Cognito, CloudFormation, S3.
- **Mobile & Web:** React Native, Web-Mobile Sync, RBAC Integration.
- **Data & DevOps:** MongoDB, MySQL, GitHub Actions, CI/CD, Infrastructure as Code.
- **Quality:** Selenium, Playwright, API Automation, ISTQB Principles.
